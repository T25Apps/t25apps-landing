...
import { APP_NAME, APP_DESCRIPTION, SOCIAL_MEDIA } from '../config/constants'
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 dotted-bg">
      <SEO 
        ...
        description={`Learn more about ${APP_NAME} and our mission to build innovative apps.`}
      />
      ...
      <main className="pt-20 pb-12 px-6 md:px-10">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="py-12 animate-fade-in-up delay-200">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {values.map((value, index) => (
                <div 
                  key={index}
                  className="bg-white dark:bg-stone-900 rounded-xl p-6 border border-stone-200 dark:border-stone-800 shadow-soft text-center"
                >
                  <div className="w-12 h-12 rounded-xl bg-stone-100 dark:bg-stone-800 flex items-center justify-center mx-auto mb-4 text-stone-600 dark:text-stone-300">
                    {value.icon}
                  </div>
                  <h3 className="text-lg font-semibold text-stone-900 dark:text-white mb-2">{value.title}</h3>
                  <p className="text-stone-500 dark:text-stone-400 text-sm leading-relaxed">{value.description}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Social Links */}
          <section className="py-12 text-center animate-fade-in-up delay-300">
            <h2 className="text-2xl font-bold text-stone-900 dark:text-white mb-6">Connect With Us</h2>
            <div className="flex justify-center gap-4">
              <a 
                href={SOCIAL_MEDIA.instagram || 'https://instagram.com/t25apps'}
                target="_blank" 
                rel="noopener noreferrer"
                className="p-4 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-800 text-stone-600 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors shadow-soft"
              >
