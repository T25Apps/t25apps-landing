          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="bg-white dark:bg-stone-900 rounded-2xl p-5 shadow-soft-xl border border-stone-200 dark:border-stone-800 overflow-y-auto max-h-[70vh]">
                ...
                <h2 className="text-base font-bold text-stone-900 dark:text-white mb-2">About T25Apps</h2>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <h3 className="text-xs font-semibold text-stone-900 dark:text-white mb-1">My Mission</h3>
                  <p className="text-[10px] text-stone-500 dark:text-stone-400 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xs font-semibold text-stone-900 dark:text-white mb-2">My Values</h3>
